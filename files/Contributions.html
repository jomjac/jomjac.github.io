...
<div style="border: 1px solid #ccc; padding: 20px; text-align: center; font-family: Arial, sans-serif;">
  ...
  <p>
    ...
    <span style="color: #3572A5;"><i class="fab fa-python"></i> Python</span>, 
    <span style="color: #1F77B4;"><i class="fab fa-r-project"></i> R</span>, 
    <span style="color: #A270BA;"><i class="fab fa-julia"></i> Julia</span>, and 
    <span style="color: #008080;"><i class="fab fa-latex"></i> LaTeX</span>.
  </p>
  <p>
